...
compute_h0 <- function(T_list, res_varsigma) {
  ...
  # Per il paper: ||ς̂||²_2 = ∫ ς̂²(t) dt  (pag. 6, Lin & Wang 2022)
  # quindi        ||ς̂||_2  = sqrt(∫ ς̂²(t) dt)
  # Nota: varsigma2_hat stima ς²(t), quindi ς̂(t) = sqrt(varsigma2_hat(t))
  # e ∫ ς̂²(t) dt = ∫ varsigma2_hat(t) dt
  # La norma corretta e' quindi: sqrt(∫ varsigma2_hat(t) dt)
